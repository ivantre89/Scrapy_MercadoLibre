...
class ScrapymercadoSpider(CrawlSpider):
		...
		def parse_item(self, response):
			...
			ml_item['ano'] = response.xpath('normalize-space(//*[@id="short-desc"]/div/article/dl/dd[1])').extract()
			...
			ml_item['ubicacion'] = response.xpath('normalize-space(/html/body/main/div/div/div[1]/div[2]/div[1]/section[2]/p[9]/span)').extract()
